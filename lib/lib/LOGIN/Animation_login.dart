...
class _AnimationLoginState extends State<AnimationLogin>
  ...
  //
  Alignment alignment1 = Alignment(-0.1, 0.8);
  Alignment alignment2 = Alignment(-0.1, 0.8);
  Alignment alignment3 = Alignment(-0.1, 0.9);
  Alignment alignment4 = Alignment(-0.1, 0.8);
  Alignment alignment5 = Alignment(-0.1, 0.8);
  Alignment home = Alignment(-0.1, 0.9);
  Alignment official = Alignment(0.0, 0.8);
  Alignment notifikasi = Alignment(-0.1, 0.7);
  Alignment keranjang = Alignment(-0.1, 0.9);
  Alignment account = Alignment(-0.1, 0.9);
  double size1 = 50.0;
  double size2 = 50.0;
  double size3 = 50.0;
  double size4 = 50.0;
          ...
          child: Transform.rotate(
            ...
            child: AnimatedContainer(
                ...
                child: Padding(
                  ...
                  child: Text('Home',style: TextStyle(fontWeight:FontWeight.bold,fontFamily: 'Comfortaa',fontSize:10,color:Colors.white),),
                )),
          ),
        ),
          ],
            ...
            child: Transform.rotate(
              ...
              child: AnimatedContainer(
                  ...
                  child: Padding(
                    ...
                    child: Text('Official Store',style: TextStyle(fontWeight:FontWeight.bold,fontFamily: 'Comfortaa',fontSize:10,color:Colors.white),),
                  )),
            ),
          ),
          ],
          ...
          child: Transform.rotate(
            ...
            child: AnimatedContainer(
                ...
                child: Padding(
                  ...
                  child: Text('Notifikasi',style: TextStyle(fontWeight:FontWeight.bold,fontFamily: 'Comfortaa',fontSize:10,color:Colors.white),),
                )),
          ),
        ),
          ],
            ...
            child: Transform.rotate(
              ...
              child: AnimatedContainer(
                  ...
                  child: Padding(
                    ...
                    child: Text('Keranjang',style: TextStyle(fontWeight:FontWeight.bold,fontFamily: 'Comfortaa',fontSize:10,color:Colors.white),),
                  )),
            ),
          ),
          ],
          ...
          child: Transform.rotate(
            ...
            child: AnimatedContainer(
                ...
                child: Padding(
                  ...
                  child: Text('Account',style: TextStyle(fontWeight:FontWeight.bold,fontFamily: 'Comfortaa',fontSize:10,color:Colors.white),),
                )),
          ),
        ),
          ],
                          ...
                          onPressed: () {
                            setState(() {
                              if (opened) {
                                ...
                                opened = !opened;
                                _controller.reverse();
                                alignment1 = Alignment(-0.1, 0.8);
                                alignment2 = Alignment(-0.1, 0.8);
                                alignment3 = Alignment(-0.1, 0.9);
                                alignment4 = Alignment(-0.1, 0.8);
                                alignment5 = Alignment(-0.1, 0.8);
                                home = Alignment(-0.1, 0.8);
                                official = Alignment(0.0, 0.8);
                                notifikasi = Alignment(-0.1, 0.7);
                                keranjang = Alignment(-0.1, 0.8);
                                account = Alignment(-0.1, 0.8);
                              }
                            });
                          },
                          icon:
