            ...
            child:ListView.builder(
              ...
              itemBuilder: (BuildContext context ,int i){
                return GestureDetector(
                  onTap: (){
                    Navigator.push(context,MaterialPageRoute(builder: (BuildContext context)=>DetailProdukHome(gambar:'https://carinih.ws/uploads/upload_images/product/${data[i]['image']}',harga:data[i]['price'],description:data[i]['description'],hashtag:data[i]['hash_tag'])));
                  },
                  child: Padding(
