...
//
  ...
  getDatastock() async {
    ...
    var response = await http.get(
        Uri.parse(Uri.encodeFull('https://carinih.ws/api/product/stock/$stock')),
        headers: {"Accept": "application/json"});
    print(response.body);
    //
    setState(() {
...
addCart() async {
   ...
   mitraid = prefs3.getString('mitraid');
    ...
    http.post(Uri.parse(Uri.encodeFull('https://carinih.ws/api/cart/addtocart')), headers: {
      'Accept': 'application/json',
      // "imei": "123456"
    }, body: {
  ...
  String mitraidname;
   getDataMitra() async {
    ...
    var response = await http.get(Uri.parse(Uri.encodeFull('https://carinih.ws/api/mitra/store_address/$mitraidname')),
        headers: {"Accept": "application/json"});
    print(response.body);
    //
    setState(() {
                ...
                children: [
                  SingleChildScrollView(
                    ...
                    children: [
                      ...
                      itemCount: datamitraname == null ? 0 : datamitraname.length,
                          ...
                          children: [
                            Text('DIjual Oleh',
                                      style: TextStyle(
                                          ...
                                          SizedBox(width: 5.w,),
                            Expanded(
                              child: Text(datamitraname[index]['store_name'],
                                              style: TextStyle(
                                                  fontFamily: 'Comfortaa',
                                                  color: Colors.deepPurple[400],
                                                  fontWeight: FontWeight.w900,)),
                      ...
                      Stack(
                        ...
                        children: [
                          Padding(
                             padding:
                          EdgeInsets.only(left: ScreenUtil().setWidth(15.w),top:5.h),
                            child: Container(
                              child: Row(
                                children: [
                                  Text(
                          ...
                          //
                           Container(
                             ...
                             child: ListView.builder(
                                shrinkWrap: true,
                                physics: NeverScrollableScrollPhysics(),
                                itemCount: datastock == null ? 0 : datastock.length,
                                itemBuilder: (context, i) {
                                  return Container(
                                    ...
                                    fontFamily: 'Comfortaa', fontSize: 12.sp),),
                                            '${datastock[i]['value']}'==null?Text('Tidak ada',style: TextStyle(
                                    fontFamily: 'Comfortaa', fontSize: 12.sp),):Text('${datastock[i]['value']}',style: TextStyle(
                                    fontFamily: 'Comfortaa', fontSize: 12.sp),)
                                          ],
                                        ),
                          ...
                          Container(
                             ...
                             child: ListView.builder(
                                shrinkWrap: true,
                                physics: NeverScrollableScrollPhysics(),
                                itemCount: kondisidata == null ? 0 :kondisidata .length,
                                itemBuilder: (context, i) {
                                  return Container(
                                    // margin:EdgeInsets.only(),
                                    child: ListTile(
                                    ...
                                    fontFamily: 'Comfortaa', fontSize: 12.sp),),
                                            '${kondisidata[i]['name']}'==null?Text('Tidak ada',style: TextStyle(
                                    fontFamily: 'Comfortaa', fontSize: 12.sp),):Text('${kondisidata[i]['name']}',style: TextStyle(
                                    fontFamily: 'Comfortaa', fontSize: 12.sp),)
                                          ],
                                        ),
                           ...
                           //
                            Container(
                             ...
                             child: ListView.builder(
                              ...
                              //
                            Padding(
                              padding:  EdgeInsets.only(left:15.w,right:15.w,top:150.h),
                              child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text(
                            ...
                            //
                             Padding(
                               padding:  EdgeInsets.only(left:15.w,right:15.w,top:168.h),
                               child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                                Text(
                             ...
                             //
                             Padding(
                                 padding:  EdgeInsets.only(left:15.w,right:15.w,top:187.h),
                               child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                                Text(
