...
addData() async {
                ...
                child:Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 10,),
                      Text(' Data Anda Berhasil DiUpdate',style: TextStyle(fontFamily: 'Comfortaa',fontSize: 13,fontWeight: FontWeight.w900)),
                     //
                     //
                     SizedBox(height: 10.h,),
                     //
                      GestureDetector(
                        onTap:(){Navigator.pushReplacement(context, MaterialPageRoute(builder:(BuildContext context)=>General()));
                        },
                        child: Container(
                          height: 30.h,
                          width: 150.w,
                          ...
                          child:Center(child: Text('Lanjutkan',style: TextStyle(fontFamily: 'Comfortaa',fontSize: 13,fontWeight: FontWeight.w900,color: Colors.white))),
                        ),
                      )
                  ],),
                )
  ...
  Future<Null> selectDate (BuildContext context) async{
    DateTime _datepicker = await showDatePicker(context: context, initialDate: _date, firstDate:DateTime(1947), lastDate: DateTime(2030));
